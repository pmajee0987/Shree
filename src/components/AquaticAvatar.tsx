  ...
  return (
    <div className="relative flex items-center justify-center w-full max-w-sm sm:max-w-md aspect-square max-h-[50vh] sm:max-h-[55vh]">
      ...
      <motion.div
        ...
        className="absolute -inset-3 sm:-inset-5 border border-dashed border-cyan-400/30 rounded-full pointer-events-none"
      />
      ...
      <motion.div
        animate={{
          rotate: -360,
          scale: isListening ? [1, 1.04, 1] : isSpeaking ? [1, 1.02 + outputLevel * 0.1, 1] : 1,
        }}
        transition={{
          rotate: { duration: 32, repeat: Infinity, ease: 'linear' },
          scale: { duration: 1.5, repeat: Infinity, ease: 'easeInOut' },
        }}
        className="absolute -inset-6 sm:-inset-8 border border-blue-400/20 rounded-full pointer-events-none"
      />
